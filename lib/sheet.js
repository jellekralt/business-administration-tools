...
class HourSheet {
    ...
    process(options, callback) {
        ...
        this.loadDaysOff(options.calendars.holidays, options.year, options.month, function() {
    ...
    loadDaysOff(calendarId, year, month, callback) {
        var _this = this;


        this.cal.getDaysOff(calendarId, year, month, function(days) {
            _this.daysOff = days;
